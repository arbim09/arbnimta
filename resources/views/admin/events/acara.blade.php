@extends('layout.backend.app',[
    'title' => 'Manage Events Acara',
    'pageTitle' =>'Manage Events Acara',
])
...
<div class="card">
        <div class="card-header d-flex align-items-center">
          <h5 class="card-title">Daftar Events Acara</h5>
          <div class="card-tools ml-auto mr-0">
              <a href="{{ route('event.create') }}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Tambah Data">
