@extends('layout.backend.app',[
    'title' => 'Manage Events Pelatihan',
    'pageTitle' =>'Manage Events Pelatihan',
])
...
<div class="card">
        <div class="card-header d-flex align-items-center">
          <h5 class="card-title">Daftar Events Pelatihan</h5>
