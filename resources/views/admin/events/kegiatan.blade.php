@extends('layout.backend.app',[
    'title' => 'Manage Events Kegiatan',
    'pageTitle' =>'Manage Events Kegiatan',
])
...
<div class="card">
        <div class="card-header d-flex align-items-center">
          <h5 class="card-title">Daftar Events Kegiatan</h5>
