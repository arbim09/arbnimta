...
<div class="card">
    <div class="card-header">
        <div class="btn-group">
            <a href="{{ route('events.index') }}" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Kembali ke Daftar Event">
                <i class="far fa-arrow-alt-circle-left mr-1"></i> Kembali
            </a>
            <a href="{{ route('events.edit', $events->id) }}" class="btn btn-sm btn-warning" data-toggle="tooltip" title="Edit Data Event">
