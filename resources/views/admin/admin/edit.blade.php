    ...
    <div class="card-body">
        <form class="row g-3" action="{{route('admin.update', $user->id)}}" method="POST" id="admin">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="input-name" placeholder="Nama Lengkap" value="{{ $user->name }}" required>
                @error('name')
            ...
            <div class="col-md-4">
                ...
                <div class="">
                    <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" id="input-email" placeholder="Email" value="{{ $user->email }}">
                    @error('email')
                    <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="">
                    <input type="text" name="no_hp" class="form-control @error('no_hp') is-invalid @enderror" id="input-no_hp" placeholder="08...." value="{{ $user->no_hp }}">
                    @error('no_hp')
                    <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="">
                    <input type="radio" id="Male" name="jenis_kelamin" value="Laki-laki" {{ $user->jenis_kelamin == 'Laki-laki' ? 'checked' : '' }}> Laki-Laki  
                    <input type="radio" class=" ml-2" id="Female" name="jenis_kelamin" value="Perempuan" {{ $user->jenis_kelamin == 'Perempuan' ? 'checked' : '' }}> Perempuan   
                </div>
                    @error('jenis_kelamin')
                    <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
            ...
            <div class="col-md-4">
                ...
                <div class="">
                    <input type="tempat_lahir" name="tempat_lahir" class="form-control" id="input-tempat_lahir" placeholder="Tempat Lahir" value="{{ $user->tempat_lahir }}">
                    @error('tempat_lahir')
                    <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="">
                    <input type="date" name="tanggal_lahir" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="input-tanggal_lahir" placeholder="Birth Date" value="{{ date('Y-m-d', strtotime($user->tanggal_lahir)) }}">
                    @error('tanggal_lahir')
                    <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="">
                    <select type="pendidikan" name="pendidikan" class="form-control" id="input-pendidikan" placeholder="pendidikan" value="{{ old('pendidikan') }}">
                        ...
                        @foreach(App\Models\User::getPendidikan('users', 'pendidikan') as $value)
                            <option value="{{ $value }}" @if($value == $user->pendidikan) selected @endif>{{ $value }}</option>
                        @endforeach            
                    </select>
                    @error('pendidikan')
                    <span class="invalid-feedback">{{ $message }}</span>
                ...
                <div class="">
                    <select type="agama" name="agama" class="form-control" id="input-agama" placeholder="agama" value="{{ old('agama') }}">
                        ...
                        @foreach(App\Models\User::getAgama('users', 'agama') as $value)
                            <option value="{{ $value }}" @if($value == $user->agama) selected @endif>{{ $value }}</option>
                        @endforeach
                    </select>
                    @error('agama')
                    <span class="invalid-feedback">{{ $message }}</span>
            ...
            <div class="col-md-4">
                ...
                <select class="form-control select2" id="pekerjaan" name="pekerjaan_id">
                    @foreach($kerja as $pkr)
                        <option value="{{ $pkr->id }}" @if($pkr->id == $user->pekerjaan_id) selected @endif>{{ $pkr->nama }}</option>
                    @endforeach
                </select>
                @error('pekerjaan')
                <span class="invalid-feedback">{{ $message }}</span>
                ...
                <div class="">
                    <select type="role" name="role" class="form-control" id="input-role" placeholder="Role" value="{{ old('role') }}">
                        @foreach(App\Models\User::getEnumValues('users', 'role') as $value)
                            <option value="{{ $value }}" @if($value == $user->role) selected @endif>{{ $value }}</option>
                        @endforeach
                    </select>
                    @error('role')
                    <span class="invalid-feedback">{{ $message }}</span>
            ...
            <div class="col-md-4">
                ...
                <div class="">
                    ...
                    @else
                        <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="input-password" placeholder="password"  maxlength="8" size="8" required>
                    @endif
                    @error('password')
                    <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
            ...
            <div class="col-md-8">
                ...
                <div class="">
                    <textarea type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="input-alamat" placeholder="Bisa diisi nama jalan atau RT / RW" value="{{ old('alamat') }}">{{$user->alamat}}</textarea>
                    @error('alamat')
                    <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
