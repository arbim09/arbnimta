...
<div class="card ">
    ...
    <div class="card-body">
        <form class="row g-3" enctype="multipart/form-data" action="{{route('banners.store')}}" method="POST" id="banners">
            @csrf
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="author" class="form-control @error('author') is-invalid @enderror" id="input-author" placeholder="Judul Berita" value="{{ Auth::user()->name }}" required>
                @error('author')
                <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
