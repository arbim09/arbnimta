            ...
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="card-tools ml-auto mr-0">
                        <a href="{{ route('pengurus.dataAnggotaExport') }}" id="export-link" class="btn btn-primary btn-sm"
    ...
    <script>
        function deleteData(id) {
            swal({
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('anggotas.destroy', ':id') }}".replace(':id', id),
                    data: {
                        "_token": "{{ csrf_token() }}"
                    },
