            ...
            <table class="table table-hover table-bordered">
                ...
                @if ($events->category->name == 'Pelatihan')
                    <tr>
                        ...
                        <td style="width: 80%;"><a href="#"><img src="data:image/png;base64,{!! base64_encode(
                            QrCode::format('png')->size(300)->generate('Ini adalah QR Code untuk kategori A'),
                        ) !!}"
                                    alt="QR Code"></a></td>
                    </tr>
                @elseif($events->category->name == 'Kegiatan')
                    <tr>
                        <th style="width: 20%;">QR Code</th>
                        <td style="width: 80%;"><a href="{{ route('form-absensi.kegiatan') }}"><img
                                    src="data:image/png;base64,{!! base64_encode(
                                        QrCode::format('png')->size(300)->generate('Ini adalah QR Code untuk kategori B'),
                                    ) !!}" alt="QR Code"></a></td>
                    </tr>
                @else
                    <tr>
                        <th style="width: 20%;">QR Code</th>
                        <td style="width: 80%;"><a href="#"><img src="data:image/png;base64,{!! base64_encode(
                            QrCode::format('png')->size(300)->generate('Ini adalah QR Code untuk kategori selain A dan B'),
                        ) !!}"
                                    alt="QR Code"></a></td>
                    </tr>
                @endif
