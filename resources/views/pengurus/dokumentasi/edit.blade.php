    ...
    <div class="card">
        <div class="card-header d-flex align-items-center">
            ...
            <div class="card-tools ml-auto mr-0">
                <a href="{{ route('event.index') }}" class="btn btn-primary btn-sm" data-toggle="tooltip"
        ...
        <div class="card-body">
            <form class="row g-3" enctype="multipart/form-data" action="{{ route('dokumen.update', $dokumentasi->id) }}"
    ...
    <script>
        $(document).ready(function() {
            $('#dokumentasi').submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('dokumen.update', ':id') }}'.replace(':id', id),
                    type: 'POST',
                    dataType: 'JSON',
                    data: formData,
                    cache: false,
