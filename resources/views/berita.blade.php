    ...
    <div class="content">
		<div class="card card-style">
            <div class="card-body px-0 py-0">
                ...
                <br>
                <div class="list-group list-custom list-group-m rounded-xs list-group-flush px-3" style="display: flex; flex-direction: column; align-items: center;">
                    <img src="{{ asset('images/posts/'.$posts->image) }}" alt="{{ $posts->title }}" class="img-fluid" style="max-width: 75%; height: auto;">
