...
<form action="{{route('absensi.pelatihan')}}" method="POST" id="pelatihan"> 
    @csrf  
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mt-5 mb-5 ml-5 mr-5">
                    <div class="container border">
                            <h5 class="mt-5 text-center">FORM ABSENSI PELATIHAN</h3>
            ...
            $.ajax({
                ...
                success: function(response) {
                    swal({
                        ...
                        location.href = "{{ route('form-absensi.pelatihan') }}";
                    });
                },
