...
<form action="{{route('absensi.acara')}}" method="POST" id="acara"> 
    @csrf  
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mt-5 mb-5 ml-5 mr-5">
                    <div class="container border">
                            <h5 class="mt-5 text-center">FORM ABSENSI Acara</h3>
...
<script>
    $(document).ready(function() {
        $('#acara').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: '{{ route('absensi.acara') }}',
                type: 'POST',
                dataType: 'JSON',
                data: $('#acara').serialize(),
                success: function(response) {
                    swal({
                        ...
                        location.href = "{{ route('form-absensi.acara') }}";
                    });
                },
