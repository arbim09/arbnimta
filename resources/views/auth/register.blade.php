		    ...
		    <div class="card card-style">
                <div class="content">
                    <h1 class="text-center font-800 font-30 mb-2">Daftar Akun</h1>
                            ...
                            <form action="{{ route('anggota.register') }}" method="POST" enctype="multipart/form-data" id="anggota">
                                @csrf
                                <div class="form-custom form-label form-icon mb-3">
                                    <i class="bi bi-person-circle font-14"></i>
                                    <input type="text" class="form-control rounded-xs" id="c1" name="name" placeholder="Nama" required/>
                                    <label for="c1" class="color-theme form-label-always-active font-10 opacity-50 @error('name') is-invalid @enderror">Nama Lengkap{!! printRequired() !!}</label>
                                    @error('name')
                                ...
                                <div class="form-custom form-label form-icon mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-xs" id="c1a" name="no_hp" placeholder="No Hp" required/>
                                    <label for="c1" class="color-theme form-label-always-active font-10 opacity-50">No Hp</label>
                                </div>
                                <div class="form-custom form-label form-icon mb-3">
                                    <i class="bi bi-at font-16"></i>
                                    <input type="text" class="form-control rounded-xs" id="c1a" name="email" placeholder="Email" required/>
                                ...
                                <div class="form-custom form-label form-icon mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-xs" id="c1" placeholder="Tempat Lahir" name="tempat_lahir" required/>
                                ...
                                <div class="form-custom form-label form-icon mb-3">
                                    ...
                                    <input type="date"  class="form-control rounded-xs" id="input-tanggal_lahir" placeholder="Tanggal Lahir" name="tanggal_lahir" required min="1900-01-01"/>
                                    <label for="c1" class="color-theme form-label-always-active font-10 opacity-50">Tanggal Lahir</label>
                                </div>
                                <div class="form-custom form-label form-icon mb-3">
                                    <i class="bi bi-calendar2-event font-16"></i>
                                    
                                    <label for="c1" class="color-theme form-label-always-active font-10 opacity-50">Umur</label>
                                </div>
                                <div class="form-custom form-label form-icon mb-3">
                                ...
                                <div class="form-custom form-label form-icon mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-xs" id="c1" placeholder="Alamat" name="alamat" required/>
                                    <label for="c1" class="color-theme form-label-always-active font-10 opacity-50">Address</label>
                                    <span>(required)</span>
                                </div>
                                <div class="form-custom form-label form-icon mb-3">
                                    <i class="bi bi-asterisk font-12"></i>
                                    <input type="password" class="form-control rounded-xs" name="password" id="c2" placeholder="Password" required/>
                                    <label for="c2" class="color-theme">Pasword</label>
                                </div>
                                <div class="form-custom form-label form-icon mb-3">
                                    <i class="bi bi-asterisk font-12"></i>
                                    <input type="password" class="form-control rounded-xs" id="c2" name="password_confirmation" placeholder="Konfirmasi Password"/>
                                    <label for="c2" class="color-theme">Konfirmasi Password</label>
                                </div>
                                <button type="submit" class='btn rounded-sm btn-m gradient-blue text-uppercase font-700 mt-4 mb-3 btn-full shadow-bg shadow-bg-s'>Daftar</button>
                            </form>
                            <div class="d-flex">
                                <div>
                                    <a href="{{route('login')}}" class="color-theme  font-12">Sudah Punya Akun? Login Sekarang!</a>
                                </div>
                            </div>
                    </div>
            </div>
